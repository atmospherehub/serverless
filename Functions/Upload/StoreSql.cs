...
namespace Functions.Upload
{
    ...
    public class RectangleHandler : SqlMapper.TypeHandler<FaceRectangle>
    {
        public override FaceRectangle Parse(object value) => throw new NotImplementedException();

        public override void SetValue(IDbDataParameter parameter, FaceRectangle value)
        {
